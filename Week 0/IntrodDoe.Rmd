...
$$s^2= \frac{(n_1-1)s_1^2+(n_2-1)s_2^2}{n_1+n_2-2}= \frac{(12-1)5^2+(13-1)6^2}{12+13-2}=30.74$$
Segundo, desarrollamos la probabilidad

$$P(\overline{X}_A-\overline{X}_B \le 5.55) = 1-P(t> \frac{(\overline{x}_1-\overline{x}_2)-(\mu_1-\mu_2)}{\sqrt{\frac{s^2}{n_1}+\frac{s^2}{n_2}}})$$ 

$$ = 1-P(t> \frac{(5.55)-(0)}{\sqrt{\frac{30.74}{12}+\frac{30.74}{13}}})$$ 
$$ = 1-P(t> 2.5)$$ 
Ahora bien, los grados de libertad son $n_1+n_2-2=12=13-2=23$, el valor de tabla obtenido es 0.01:

...
::: {style="text-align:center"}
![](images/tabla_ej1.png){width="724"}
:::
...
Dado que $p-valor < \alpha$, rechazamos $H_0$, es decir al menos una media es diferente.En otras palabras, el peso porcentual del algodol incide en la resistencia a la tensión.
...
$$7.15 \leq \mu_1 \leq 12.45$$
Análogamente para el tratamiento 2: 

$$12.75 \leq \mu_2 \leq 18.05$$
Para el tratamiento 3: 

$$14.95 \leq \mu_3 \leq 20.25$$
Para el tratamiento 4: 

$$18.95 \leq \mu_4 \leq 24.25$$
